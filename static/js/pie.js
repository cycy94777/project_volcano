...
let labels = ['6000 to 7000', '5000 to 6000', '4000 to 5000', '3000 to 4000', '2000 to 3000', '1000 to 2000', '0 to 1000', '0 to -1000', '-1000 to -2000', '-2000 to -3000', '-3000 to -4000', '-4000 to -5000', '-5000 to -6000']
function init() {
    let trace2 = [{
        values: values,
        labels: labels,
